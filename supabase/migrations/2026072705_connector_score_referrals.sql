-- Replace the invite_codes factor in compute_connector_score() with referrals.
-- +5 per person who joined via this member's personal referral link.
-- Renames the output key from 'invites_redeemed' to 'referrals'.
